...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('productcatalog_product', 'updated_at', models.DateTimeField(auto_now_add=True, auto_now=True, null=True))
        
        # Adding field 'Product.created_at'
        db.add_column('productcatalog_product', 'created_at', models.DateTimeField(auto_now_add=True, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('productcatalog_product', 'updated_at')
        
        # Deleting field 'Product.created_at'
        db.delete_column('productcatalog_product', 'created_at')
