...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('warehouse_item', 'blocked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.blocked'
        db.delete_column('warehouse_item', 'blocked')
