...
STATES = settings.PINAX_BLOG_UNPUBLISHED_STATES + [_("Published")]
...
class Post(models.Model):
    ...
    section = models.IntegerField(choices=SECTION_CHOICES, verbose_name=_("Section"))

    title = models.CharField(max_length=90, verbose_name=_("Title"))
    slug = models.SlugField(unique=settings.PINAX_BLOG_SLUG_UNIQUE, verbose_name=_("Slug"))
    author = models.ForeignKey(User, related_name="posts", verbose_name=_("Author"))

    markup = models.CharField(max_length=25, choices=settings.PINAX_BLOG_MARKUP_CHOICES, verbose_name=_("Markup"))

    teaser_html = models.TextField(editable=False)
    content_html = models.TextField(editable=False)

    description = models.TextField(blank=True, verbose_name=_("Description"))
    primary_image = models.ForeignKey("Image", null=True, blank=True, related_name="+", verbose_name=_("Image"))
    ...
    state = models.IntegerField(choices=STATE_CHOICES, default=STATE_CHOICES[0][0], verbose_name=_("state"))
