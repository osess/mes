...
class State(models.Model):
    ...
    **Attributes:**
    ...
    #this is a custom field by xxd.used to add hiden attribute to state
    #status = models.PositiveSmallIntegerField(choices=CHOICE_STATE_STATUS, default=1, verbose_name=_(u"status"))
