    ...
    , click: function(e) {
      ...
      if(!this.modal){
        var modal = $('<div class="modal fade quick-form" role="dialog"><div class="modal-dialog"><div class="modal-content">'+
          ...
          '<div class="modal-footer" style="display: none;"><button class="btn btn-default" data-dismiss="modal" aria-hidden="true">'+gettext('关闭')+'</button>'+
          '<a class="btn btn-primary btn-submit">'+gettext('添加')+'</a></div></div></div></div>')
        $('body').append(modal)
